...
//Create DB schema and collection
...
app.post("/compose", function(req, res) {
  ...
  //Create new post document and save into DB
  const newPost = new Post({
    title: req.body.postTitle,
    content: req.body.postBody
  });

  //Redirect to home page when there is no error in saving
...
app.get("/posts/:postId", function(req, res) {
  //Retrieve post and render full post
